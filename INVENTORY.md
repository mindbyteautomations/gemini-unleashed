...
| **`gemini-spark-redis-memory-mcp`** | `https://gemini-spark-redis-memory-mcp-274212548408.us-central1.run.app` | Containerized Redis Database & Agent Memory Microservice (Archived & Backed Up) |
